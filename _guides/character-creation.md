...
## Traits
In 3.0, "Medical History" has been replaced with *Traits* thanks [shazdeh](https://next.nexusmods.com/profile/shazdeh2/mods?gameId=1704). This mod adds a host of new traits, inspired by Fallout New Vegas, with the goal of creating new and fun playstyles. At the beginning of the game you're given a power "Select Traits", activating it displays the menu where you can pick up to 2 desired trait.
